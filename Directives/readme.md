...
5. When clicking on an the directive element the user should be asked (using $window.confirm) if he wants to navigate away from the page, if yes then redirect him to question's url.
